function fullPage() {
    // THE PURCHASED fullPage HOBBY SOFTWARE WAS LICENSED - 05/12/2021
    $("#js-fullpage").fullpage({
        easingcss3: "cubic-bezier(0.645, 0.045, 0.355, 1)",
        scrollingSpeed: 1e3,
        anchors: ["top", "about-me", "team", "footer"],
        navigation: !0,
...
function headerColor() {
    ...
    $(window).on("scroll", function() {
        "top" !== a && $(window).scrollTop() > $(window).height() ? ($("header").addClass("js-color"),
...
$(function() {
    $win.on("load resize", function() {
        ...
        // console.log("pc" + isSp)) 
        1) : window.matchMedia("(min-width: 421px)").matches && (isSp = !1,
        fpnav = {
            y: "100%",
            x: 0
        },
...
Barba.Dispatcher.on("newPageReady", function() {
    $("#js-fullpage").length && (new Parallax($(".js-parallax-moon").get(0)),
