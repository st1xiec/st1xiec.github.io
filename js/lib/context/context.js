...
class ContextMenu {
    constructor(container, items) {
        ...
        this._onclick = e => {
            if (this.dom && e.target != this.dom &&
                ...
                !e.target.classList.contains('item__ltGCqR') &&
                !e.target.parentElement.classList.contains('item__ltGCqR')) {
                this.hideAll();
            }
        };
    ...
    itemToDomEl(data) {
        ...
        item.classList.add('item__ltGCqR');

        const icon = document.createElement('i');
        icon.classList.add(...['fas', `fa-${data['icon']}`]);
